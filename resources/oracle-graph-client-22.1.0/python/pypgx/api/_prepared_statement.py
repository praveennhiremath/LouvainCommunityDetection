...
from pypgx._utils.item_converter import convert_to_java_type, convert_to_java_list
...
class PreparedStatement:
    ...
    def __init__(self, java_prepared_statement) -> None:
    ...
    def set_date(self, parameter_index: int, x: date) -> None:
        ...
        :param x: The parameter value
        """
        x = convert_to_java_type(x)
        java_handler(self.java_prepared_statement.setDate, [parameter_index, x])
    ...
    def set_time(self, parameter_index: int, x: time) -> None:
        ...
        """
        x = convert_to_java_type(x)
        java_handler(self.java_prepared_statement.setTime, [parameter_index, x])
    ...
    def set_time_with_timezone(self, parameter_index: int, x: time) -> None:
        ...
        """
        x = convert_to_java_type(x)
        java_handler(self.java_prepared_statement.setTimeWithTimezone, [parameter_index, x])
    ...
    def set_timestamp(self, parameter_index: int, x: datetime) -> None:
        ...
        """
        x = convert_to_java_type(x)
        java_handler(self.java_prepared_statement.setTimestamp, [parameter_index, x])
    ...
    def set_timestamp_with_timezone(self, parameter_index: int, x: datetime) -> None:
        ...
        """
        x = convert_to_java_type(x)
        java_handler(self.java_prepared_statement.setTimestampWithTimezone, [parameter_index, x])
